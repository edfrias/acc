    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div class="p-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <button
                ...
                aria-label="Inscribirse al programa de iniciación"
              >
                Inscribirse
              </button>
            </div>
        ...
        <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
          <div class="p-6">
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-3">Perfeccionamiento Técnico</h2>
            <p class="text-gray-600 mb-4">
              Programa avanzado para mejorar precisión y consistencia. Incluye análisis técnico y
            ...
            <div class="flex items-center justify-between">
              ...
              <button
                class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium"
                aria-label="Inscribirse al programa de perfeccionamiento"
              >
                Inscribirse
              </button>
            </div>
        ...
        <article class="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
          <div class="p-6">
            ...
            <h2 class="text-xl font-semibold text-gray-900 mb-3">Arqueros Junior</h2>
            <p class="text-gray-600 mb-4">
              Programa especialmente diseñado para niños y adolescentes de 8 a 16 años.
              Desarrollo de coordinación, concentración y disciplina.
            </p>
            <ul class="text-sm text-gray-600 space-y-2 mb-6">
              <li class="flex items-center">
                <svg class="w-4 h-4 text-blue-500 mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="flex items-center justify-between">
              ...
              <button
                class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-200 font-medium"
                aria-label="Inscribirse al programa junior"
              >
                Inscribirse
              </button>
            </div>
      ...
      <div class="text-center mt-12">
        ...
        <button class="btn-secondary">
          Consulta Nuestros Entrenamientos Personalizados
        </button>
      </div>
    </div>
  </section>
